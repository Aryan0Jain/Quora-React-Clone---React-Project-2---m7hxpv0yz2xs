...
import background from "@/public/images/login-signup/desktop-background.webp";
			...
			<div className="bg-white rounded max-w-[700px] flex flex-col items-center mx-3 dark:bg-[#262626]">
				<div className="flex flex-col items-center mb-10 px-2 text-center">
					<svg
						...
						height="115px"
						viewBox="0 0 202 115"
						className="sm:h-[100px] h-[80px] sm:w-[175px] w-[150px]"
					>
						<g
							stroke="none"
							fill="none"
							fillRule="evenodd"
							className="fill-[rgb(185,43,39)]"
						>
					...
					<div className="text-[#636466] font-bold dark:text-[#b1b3b6] text-[14px] sm:text-[15px]">
