...
export default function AnswerIconFilled() {
	return (
		<svg
			width="24"
			height="24"
		...
		>
			...
			<path d="M4.05 18.11L3.6 19.46C3.51 19.73 3.58 20.03 3.78 20.23C3.92 20.37 4.11 20.45 4.31 20.45C4.39 20.45 4.47 20.44 4.55 20.41L5.9 19.96L4.05 18.11Z"></path>
